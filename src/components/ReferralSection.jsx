...
import { ArrowLeft, Gift, Copy, Check, Users, Zap, Share2, Star, Sparkles, Trophy, ChevronRight, Link2, Twitter, MessageCircle, LayoutDashboard } from 'lucide-react'
import PartnerDashboard from './PartnerDashboard'
import { ReferralMilestones } from '../assets/marketing'
...
const ReferralSection = ({ onBack, userFetch }) => {
  ...
  const [view, setView] = useState('referral') // 'referral' or 'partner'
  ...
  const load = () => {
    ...
    .then(user => {
      ...
      if (user.user_type === 'influencer') setView('partner')
      setLoading(false)
    })
    .catch(err => {
  ...
  if (view === 'partner') {
    return <PartnerDashboard onBack={() => {
      if (userType === 'influencer') setView('referral')
      else onBack()
    }} userFetch={userFetch} />
  }
    ...
    <div className="fade-in-up">
      ...
      <div className="card overflow-hidden">
        ...
        <div className="p-6">
          ...
          {/* Referral Progression (Marketing Asset) */}
          <div className="mb-8">
            <ReferralMilestones 
